    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'phone' => [
                ...
                'max:15', 
                'unique:users', 
                // Regex: Memastikan format seperti 08xxxxxxxxxx atau +62xxxxxxxxxx
                'regex:/^(\+62|08)[0-9]{8,13}$/' 
            ],
            // Password: minimal 8, mixedCase, numbers, symbols
            'password' => [
                'required', 
                'confirmed', 
        ...
        // 2. Pesan Kesalahan Kustom (Custom Error Messages)
        [
            // Messages for 'name'
